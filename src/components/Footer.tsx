  ...
  return (
    <footer className="mt-16 border-t border-border bg-secondary/40 md:mt-24">
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="mb-6 flex flex-col items-start gap-2 md:mb-10 md:items-center md:text-center">
          <Logo />
          <p className="max-w-md text-xs text-muted-foreground sm:text-sm">
            Free TikTok downloader — videos without watermark, stories, photos, and MP3 audio. Works on any device.
          </p>
        </div>
        <div className="mx-auto grid max-w-3xl grid-cols-3 gap-3 sm:gap-6 md:justify-items-center md:text-center">
      ...
      <div className="border-t border-border">
        <div className="container mx-auto flex flex-col items-center justify-center gap-1 px-4 py-4 text-center text-[10px] text-muted-foreground sm:text-xs md:py-5">
